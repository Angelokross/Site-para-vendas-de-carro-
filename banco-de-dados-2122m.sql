...
-- -----------------------------------------------------
-- Table `concessionaria2122n`.`funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria2122n`.`funcionario` (
...
CREATE TABLE IF NOT EXISTS `concessionaria2122n`.`venda` (
  ...
  CONSTRAINT `fk_venda_funcionario1`
    ...
    REFERENCES `concessionaria2122n`.`funcionario` (`id_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
