...
<form action="?page=salvar-funcionario" method="POST">
	...
	<div class="mb-3">
		<label>Nome
			<input type="text" name="nome_funciario" class="form-control" value="<?php print $row->nome_funcionario;?>">
		</label>
	</div>
	<div class="mb-3">
		<label>E-mail
	...
	<div class="mb-3">
		<label>Telefone
			<input type="telefone" name="telefone_funcionario" class="form-control" value="<?php print $row->telefone_funcionario;?>">
		</label>
	</div>
	<div>
